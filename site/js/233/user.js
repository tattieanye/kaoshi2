...
function get_state(list) {
    ...
    if (layout == 'layout/store_layout.php' || act_op == 'goods_index') {
        var store_id = 0;
        var store_name = '';
            ...
            if (t_msg['error']) {
                ...
                if (connect === 1) {
                    ...
                    if (chat_goods_id > 0 && typeof goods_list[chat_goods_id] === "object") {
                        ...
                        if (chat_goods['store_id'] == user_list[user_show]['s_id']) {
...
function get_msg(list) {
    ...
    for (var k in list) {
        ...
        if (typeof msg_list[u_id][m_id] === "object") {
            continue;
        }
...
function get_goods_list(s_id) {
    if (layout == 'layout/seller_layout.php' || act_op == 'goods_index') {
        return;
    }
