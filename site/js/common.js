...
function login_dialog() {
    window.location.href = 'https://www.nanshig.com/shop/index.php?act=login&op=index&ref_url=' + window.location.href;
    //$.show_nc_login();
}
...
function weixin_login() {
    ...
    $.getScript("http://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js", function () {
        var obj = new WxLogin({
            ...
            scope: "snsapi_login",
            redirect_uri: SHOP_SITE_URL + "/index.php?act=connect_wx&op=get_info",
            state: "",
            style: "",
            href: ""
        });
...
(function ($) {
    $.show_nc_login = function (options) {
        ...
        if (connect_qq == '1') {
            add_html += '<a href="' + SHOP_SITE_URL + '/index.php?act=connect_qq" title="QQ账号登录" class="qq"><i></i></a>';
        }
        if (connect_sn == '1') {
            add_html += '<a href="' + SHOP_SITE_URL + '/index.php?act=connect_sina" title="新浪微博账号登录" class="sina"><i></i></a>';
        }
        if (connect_wx == '1') {
        ...
        login_dialog_html.append('<form class="bg" method="post" id="ajax_login" action="' + settings.action + '"></form>').find('form')
            ...
            .append('<ul><li>›&nbsp;如果您没有登录账号，请先<a class="register" href="' + SHOP_SITE_URL + '/index.php?act=login&amp;op=register">注册会员</a>然后登录</li><li>›&nbsp;如果您<a class="forget" href="' + SHOP_SITE_URL + '/index.php?act=login&amp;op=forget_password">忘记密码</a>？，申请找回密码</li></ul>')
